...
import org.georgie.security.ISecurityUserService;
...
public class RegistrationController {
    ...
    public String confirmRegistration(final Locale locale, final Model model, @RequestParam("token") final String token) throws UnsupportedEncodingException {
        ...
        if (result.equals("valid")) {
            ...
            return "redirect:/auth/login?lang=" + locale.getLanguage();
        }
    ...
    private SimpleMailMessage constructResendVerificationTokenEmail(final String contextPath, final Locale locale, final VerificationToken newToken, final User user) {
        final String confirmationUrl = contextPath + "/auth/registrationConfirm.html?token=" + newToken.getToken();
